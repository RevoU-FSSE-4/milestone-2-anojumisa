							...
							<li className="">
								<div className=" flex flex-col mt-6 mx-1 my-4 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-96 ">
									...
									<div className="p-6 pt-0">
										<button
											className="align-middle select-none font-sans font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 px-6 rounded-lg bg-red-600 text-white shadow-md shadow-gray-900/10 hover:shadow-lg hover:bg-red-900 shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none"
											type="button"
